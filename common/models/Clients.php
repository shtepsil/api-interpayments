...
class Clients extends SActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['username', 'email', 'password', 'access_token'], 'trim'],
            [['username', 'email'], 'unique', 'message' => '{attribute} уже занят'],
            [['username', 'email', 'access_token'], 'required', 'message' => 'Поле {attribute} не может быть пустым'],
            [['password'], 'required', 'on' => Clients::SCENARIO_NEW_CLIENT, 'message' => 'Поле {attribute} не может быть пустым'],
