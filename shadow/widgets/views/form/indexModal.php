...
/*
 * Из FormParams, в ключе "errors" можно передавать ошибки,
 * предупреждения и прочие неожиданности.
 */
if (isset($errors)) {
    echo $errors['message'];
} else {
    ...
    <div id="pageEdit">
        ...
        <div class="layer-loading" style="width: 97%;height: 105.77%;"></div>
        <?= Html::hiddenInput('id', $item->id) ?>
        <div style="position: relative;">
            <div class="form-actions panel-footer hidden" style="padding-left: 0px;padding-top: 0px;">
                <?= Html::submitButton('<i class="fa fa-retweet"></i> Сохранить', ['class' => 'btn btn-success btn-save btn-sm', 'data-hotkeys' => 'ctrl+s', 'name' => 'continue']) ?>
                <?php if (isset($cancel)): ?>
                    &nbsp;&nbsp;
            ...
            <?if(ADMIN_FORM_DEBUG_RES){echo d::res(false, 'res-create-user-address');}?>
