    ...
    <table class="table img_files">
        ...
        <tr ng-repeat="item in uploader.queue">
            ...
            <td nowrap>
                ...
                <?php if ($context->isVisible) : ?>
                    <button type="button"
                            ng-disabled="!item.file.id"
                            class="btn btn-secondary btn-xs"
                            ng-click="item.toggleVisibility('<?=(!empty($context->visibilityUrl) ? $context->visibilityUrl : '')?>')">
                        <span class="glyphicon" ng-class="{'glyphicon-eye-open': !item.file.isVisible, 'glyphicon-eye-close': item.file.isVisible}"></span>
                        {{!item.file.isVisible ? 'Показать' : 'Скрыть'}}
                    </button>
                <?php endif; ?>
            </td>
        </tr>
