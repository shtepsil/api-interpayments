        ...
        <ul class="nav navbar-right top-nav pull-right">
                        ...
                        <ul class="pa-20">
                            ...
                            <li class="col-md-6 col-xs-12 preview-carousel">
                                ...
                                <div class="product-carousel owl-carousel owl-theme text-center">
                                    <a href="#">
                                        <?= Html::img('img/chair.jpg', ['alt' => 'chair'])?>
                                        <span>Circle chair</span>
                                    </a>
                                    <a href="#">
                                        <?= Html::img('img/chair2.jpg', ['alt' => 'chair'])?>
                                        <span>square chair</span>
                                    </a>
                                    <a href="#">
                                        <?= Html::img('img/chair3.jpg', ['alt' => 'chair'])?>
                                        <span>semi circle chair</span>
                                    </a>
                                    <a href="#">
                                        <?= Html::img('img/chair4.jpg', ['alt' => 'chair'])?>
                    ...
                    <li>
                        <div class="streamline message-nicescroll-bar">
                            ...
                            <div class="sl-item">
                                <a href="javascript:void(0)">
                                    <div class="sl-avatar">
                                        <?= Html::img('img/avatar.jpg', ['alt' => 'avatar', 'class' => 'img-responsive'])?>
                                    </div>
                                    <div class="sl-content">
            ...
            <li class="dropdown auth-drp">
                <a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown">
                    <?= Html::img('img/user1.png', ['alt' => 'user_auth', 'class' => 'user-auth-img img-circle'])?>
